...
export function getNoirContractGuide(): string {
...
export function getPrivacyPatternsGuide(): string {
...
export function getAccountsGuide(): string {
...
export function getBridgingGuide(): string {
...
export function getCLIReferenceGuide(): string {
